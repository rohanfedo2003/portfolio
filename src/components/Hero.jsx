        ...
        <div id="home" className="w-full min-h-screen flex flex-col items-center justify-center px-4 text-center py-20">
            <div className="mb-6 relative">
                ...
                <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto">
                    <img src="src\assets\WhatsApp Image 2026-02-04 at 12.20.29 PM (1).jpeg" alt="Profile" className="w-full h-full object-cover" />
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <a href="src\assets\Rohan CV (1).pdf" download="Rohan_CV.pdf"className="px-8 py-3.5 bg-white border border-gray-200 text-black rounded-full font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 shadow-sm hover:shadow-md">
                    my resume <span>⬇</span>
                </a>
            </div>
        </div>
